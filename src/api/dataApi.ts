...
export async function fetchCredentials(params?: {
  ...
  return apiClient.get<PaginatedResponse<CredentialItem>>(
    "/credentials",
    queryParams,
  );
}
...
export async function fetchCredentialById(
  ...
  return apiClient.get<CredentialDetail>(
...
export async function updateCredential(
  ...
  return apiClient.put<CredentialItem>(
    `/credentials/${encodeURIComponent(id)}`,
    payload,
  );
}
...
export async function updateTenant(
  ...
  return apiClient.put<TenantItem>(
...
export async function fetchKeyUsageLogs(params?: {
  ...
  return apiClient.get<PaginatedResponse<KeyUsageLogItem>>(
    "/key-usage",
    queryParams,
  );
}
...
export async function fetchKeyUsageStatsByKey(params?: {
  ...
  if (params?.startDate) queryParams.startDate = params.startDate;
  if (params?.endDate) queryParams.endDate = params.endDate;
  return apiClient.get<KeyUsageStatsByKey[]>(
    "/key-usage/stats/by-key",
    queryParams,
  );
}
...
export async function fetchKeyUsageStatsByWorkflow(params?: {
  ...
  if (params?.startDate) queryParams.startDate = params.startDate;
  if (params?.endDate) queryParams.endDate = params.endDate;
  return apiClient.get<KeyUsageStatsByWorkflow[]>(
    "/key-usage/stats/by-workflow",
    queryParams,
  );
}
