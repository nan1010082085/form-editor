...
describe("ComponentPanel search", () => {
  ...
  describe("pinyin initial matching", () => {
    ...
    it('matches "文本输入" with query "wbsr"', () => {
      expect(
        matchItem({ name: "TextInput", displayName: "文本输入" }, "wbsr"),
      ).toBe(true);
    });
    ...
    it('matches "下拉选择" with query "xltz"', () => {
      ...
      expect(
        matchItem({ name: "Select", displayName: "下拉选择" }, "xlxz"),
      ).toBe(true);
    });

    it('matches partial pinyin initials "wb" for "文本输入"', () => {
      expect(
        matchItem({ name: "TextInput", displayName: "文本输入" }, "wb"),
      ).toBe(true);
    });
  });
  ...
  describe("pinyin full matching", () => {
    it('matches "按钮" with full pinyin "anniu"', () => {
      ...
      expect(matchItem({ name: "Button", displayName: "按钮" }, "anniu")).toBe(
        true,
      );
    });
    ...
    it('matches "文本输入" with full pinyin "wenben"', () => {
      expect(
        matchItem({ name: "TextInput", displayName: "文本输入" }, "wenben"),
      ).toBe(true);
    });

    it('does not match wrong pinyin "xyz" for "按钮"', () => {
      expect(matchItem({ name: "Button", displayName: "按钮" }, "xyz")).toBe(
        false,
      );
    });
  });
  ...
  describe("Chinese text direct matching", () => {
    it('matches "按钮" with query "按钮"', () => {
      expect(matchItem({ name: "Button", displayName: "按钮" }, "按钮")).toBe(
        true,
      );
    });

    it('matches partial Chinese "按" for "按钮"', () => {
      expect(matchItem({ name: "Button", displayName: "按钮" }, "按")).toBe(
        true,
      );
    });
  });
  ...
  describe("English name matching", () => {
    it('matches "Button" with query "button"', () => {
      expect(matchItem({ name: "Button", displayName: "按钮" }, "button")).toBe(
        true,
      );
    });
    ...
    it('matches "TextInput" with query "text"', () => {
      expect(
        matchItem({ name: "TextInput", displayName: "文本输入" }, "text"),
      ).toBe(true);
    });
  });
  ...
  describe("no match", () => {
    it("does not match unrelated query", () => {
      expect(matchItem({ name: "Button", displayName: "按钮" }, "zzzzz")).toBe(
        false,
      );
    });
  });
