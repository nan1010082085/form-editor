...
describe("schemaTransform", () => {
  ...
  describe("insertAtPath", () => {
    ...
    it("creates children array on parent if missing", () => {
      ...
      const schema: PartialWidget[] = [{ type: "card", label: "Empty" }];
      const newItem: PartialWidget = { type: "input", field: "x", label: "X" };
