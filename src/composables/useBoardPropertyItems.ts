...
export function useBoardPropertyItems(t: TranslateFn) {
  ...
  const boardPropertyItems = computed<BoardPropertyItem[]>(() => {
    ...
    const items: BoardPropertyItem[] = [
      {
        key: "layoutMode",
        label: t("editor.property.layoutMode"),
        type: "text",
        value: isFree
      ...
      },
      {
        ...
        options: BOARD_THEME_PRESETS.map((p) => ({
          label: p.label,
          value: p.id,
        })),
      },
    ...
    if (isFree) {
      items.push(
        {
          key: "freeLayout.maxContentWidth",
          label: t("editor.property.maxContentWidth"),
          type: "number",
          value: c.freeLayout?.maxContentWidth ?? "",
          desc: t("editor.property.maxContentWidthDesc"),
        },
        {
          key: "freeLayout.contentAlign",
          label: t("editor.property.contentAlign"),
          type: "select",
          value: c.freeLayout?.contentAlign ?? "left",
          options: [
        ...
        {
          key: "freeLayout.marginX",
          label: t("editor.property.marginX"),
          type: "text",
          value: c.freeLayout?.marginX ?? "0",
          desc: t("editor.property.marginXDesc"),
        },
        {
          key: "freeLayout.snapToGrid",
          label: t("editor.property.snapToGrid"),
          type: "switch",
          value: c.freeLayout?.snapToGrid ?? false,
          desc: t("editor.property.snapToGridDesc"),
        },
        {
          key: "freeLayout.gridColumns",
          label: t("editor.property.gridColumns"),
          type: "select",
          value: c.freeLayout?.gridColumns ?? 24,
          desc: t("editor.property.gridColumnsDesc"),
          options: [
        ...
        {
          key: "freeLayout.gridRowHeight",
          label: t("editor.property.gridRowHeight"),
          type: "number",
          value: c.freeLayout?.gridRowHeight ?? 8,
          desc: t("editor.property.gridRowHeightDesc"),
        },
      );
    }
    ...
    if (isFree) {
      items.push(
        {
          key: "width",
          label: t("editor.property.canvasWidth"),
          type: "number",
          value: c.width,
          desc: t("editor.property.canvasWidthDesc"),
        },
        {
          key: "widthUnit",
          label: t("editor.property.widthUnit"),
          type: "select",
          value: c.widthUnit ?? "px",
          desc: t("editor.property.widthUnit"),
          options: unitOptions.value,
        },
        {
          key: "height",
          label: t("editor.property.canvasHeight"),
          type: "number",
          value: c.height,
          desc: t("editor.property.canvasHeightDesc"),
        },
        {
          key: "heightUnit",
          label: t("editor.property.heightUnit"),
          type: "select",
    ...
    items.push(
      {
        ...
        desc: t("editor.property.backgroundColorDesc"),
      },
      {
        key: "padding",
        label: t("editor.property.padding"),
        type: "text",
        value: c.padding,
        desc: t("editor.property.paddingDesc"),
      },
    );
    if (!isFree) {
      items.push({
        key: "zoom",
        label: t("editor.property.zoom"),
        type: "number",
        value: c.zoom,
        desc: t("editor.property.zoomDesc"),
      });
    }
    return items;
  });
