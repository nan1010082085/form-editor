...
const fixedOptions = [
  {
    ...
    value: undefined as boolean | "left" | "right" | undefined,
  },
...
function updateColumn<K extends keyof SearchListColumnSchema>(
  index: number,
  field: K,
  value: SearchListColumnSchema[K],
) {
  ...
  <div :class="styles['columns-editor']">
    ...
    >
      <div :class="styles['columns-editor__item-header']">
        <span :class="styles['columns-editor__item-title']">{{
      ...
      <div :class="styles['columns-editor__field']">
        <label :class="styles['columns-editor__label']">{{
      ...
      <div :class="styles['columns-editor__field']">
        ...
        <el-input
          ...
          @update:model-value="
            (v: string) => updateColumn(idx, 'width', v || undefined)
          "
        />
      </div>
      ...
      <div :class="styles['columns-editor__field']">
        ...
        <el-input
          ...
          @update:model-value="
            (v: string) => updateColumn(idx, 'minWidth', v || undefined)
          "
        />
      </div>
      ...
      <div :class="styles['columns-editor__field']">
        ...
        <el-select
          ...
          @update:model-value="
            (v: string) =>
              updateColumn(idx, 'render', v as SearchListColumnSchema['render'])
          "
        >
          <el-option
      ...
      <div
        v-if="needsColorMap(col.render)"
        :class="styles['columns-editor__field']"
      >
        <label :class="styles['columns-editor__label']">{{
      ...
      <div
        v-if="needsColorMap(col.render)"
        :class="styles['columns-editor__api-section']"
      >
        <div :class="styles['columns-editor__field']">
          <label :class="styles['columns-editor__label']">{{
            t("editor.columnsEditor.apiUrl")
          }}</label>
          <el-input
        ...
        <template v-if="col.api?.url">
          <div :class="styles['columns-editor__field']">
            <label :class="styles['columns-editor__label']">{{
              t("editor.columnsEditor.requestMethod")
            }}</label>
            <el-select
          ...
          <div
            :class="[
              styles['columns-editor__field'],
              styles['api-config__field--row'],
            ]"
          >
            <div style="flex: 1">
              <label :class="styles['columns-editor__label']">{{
                t("editor.columnsEditor.labelField")
              }}</label>
              <el-input
                ...
                @update:model-value="
                  (v: string) =>
                    updateColumnApi(idx, { labelKey: v || undefined })
                "
              />
            </div>
            <div style="flex: 1">
              <label :class="styles['columns-editor__label']">{{
                t("editor.columnsEditor.valueField")
              }}</label>
              <el-input
                ...
                @update:model-value="
                  (v: string) =>
                    updateColumnApi(idx, { valueKey: v || undefined })
                "
              />
            </div>
          </div>
      ...
      >
        ...
        <el-input
          ...
          size="small"
          :placeholder="t('editor.columnsEditor.tooltipFieldPlaceholder')"
          @update:model-value="
      ...
      >
        <label :class="styles['columns-editor__label']">{{
          t("editor.columnsEditor.linkEvent")
        }}</label>
        <el-input
      ...
      >
        ...
        <el-input
          ...
          size="small"
          :placeholder="t('editor.columnsEditor.renderFnPlaceholder')"
          @update:model-value="
      ...
      <div :class="styles['columns-editor__field']">
        <label :class="styles['columns-editor__label']">{{
          t("editor.columnsEditor.sortable")
        }}</label>
        <el-switch
      ...
      <div :class="styles['columns-editor__field']">
        ...
        <el-select
          ...
          @update:model-value="
            (v: string) =>
              updateColumn(idx, 'fixed', v as SearchListColumnSchema['fixed'])
          "
        >
          <el-option
      ...
      <div :class="styles['columns-editor__field']">
        ...
        <el-select
          ...
          @update:model-value="
            (v: string) =>
              updateColumn(idx, 'align', v as SearchListColumnSchema['align'])
          "
        >
          <el-option
