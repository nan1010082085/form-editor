        ...
        <template v-for="item in section.items" :key="item.key">
          <div v-if="item.type === 'columns'" :class="styles.columnsSection">
            ...
            <TableColumnsEditor
              ...
              @update:columns="
                (v: TableColumn[]) => emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'advanced-columns'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <AdvancedColumnsEditor
              :columns="(item.value as AdvancedTableColumn[]) ?? []"
              @update:columns="
                (v: AdvancedTableColumn[]) =>
                  emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'action-buttons'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <ActionButtonsEditor
              ...
              @update:buttons="
                (v: ActionButton[]) => emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'search-fields'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <SearchFieldsEditor
              ...
              @update:search-fields="
                (v: SearchFieldSchema[]) => emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'crud-form-fields'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <CrudFormFieldsEditor
              ...
              @update:fields="
                (v: CrudFormFieldSchema[]) =>
                  emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'adhoc-fields'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <AdhocFieldsEditor
              ...
              @update:fields="
                (v: AdhocQueryField[]) => emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'kanban-columns'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <KanbanColumnsEditor
              ...
              @update:columns="
                (v: KanbanColumn[]) => emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'number-array'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <NumberArrayEditor
          ...
          <div
            v-else-if="item.type === 'array-editor'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <GenericArrayEditor
          ...
          />
          <div
            v-else-if="item.type === 'border-editor'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <BorderEditor
              ...
              @update="
                (p: Record<string, string>) => emit('updateStylePatch', p)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'border-radius-editor'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <BorderRadiusEditor
          ...
          <div
            v-else-if="item.type === 'spacing-margin-editor'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <SpacingEditor
          ...
          <div
            v-else-if="item.type === 'spacing-padding-editor'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <SpacingEditor
          ...
          <div
            v-else-if="item.type === 'shadow-editor'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <ShadowEditor
          ...
          <div
            v-else-if="item.type === 'background-editor'"
            :class="styles.columnsSection"
          >
            <div :class="styles.columnsLabel">{{ item.label }}</div>
            <BackgroundEditor
          ...
          <div v-else-if="item.type === 'rules'" :class="styles.columnsSection">
            ...
            <RulesEditor
              ...
              @update:rules="
                (v: any[] | undefined) => emit('updateProperty', item.key, v)
              "
            />
          </div>
          <div
            v-else-if="item.type === 'number' && item.unitKey"
            :class="styles.field"
          >
            <el-tooltip
            ...
            <div :class="styles.control" style="display: flex; gap: 4px">
              ...
              <el-select
                ...
                style="width: 56px"
                @update:model-value="
                  (v: unknown) => emit('updateProperty', item.unitKey!, v)
                "
              >
