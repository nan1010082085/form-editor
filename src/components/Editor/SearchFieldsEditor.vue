...
const typeOptions = computed(() => [
  ...
  {
    label: t("editor.searchFieldsEditor.typeNumber"),
    value: "number" as const,
  },
  {
    label: t("editor.searchFieldsEditor.typeSelect"),
    value: "select" as const,
  },
  { label: t("editor.searchFieldsEditor.typeRadio"), value: "radio" as const },
  {
    label: t("editor.searchFieldsEditor.typeCheckbox"),
    value: "checkbox" as const,
  },
  { label: t("editor.searchFieldsEditor.typeDate"), value: "date" as const },
  {
    label: t("editor.searchFieldsEditor.typeDateRange"),
    value: "date-range" as const,
  },
]);
...
function removeField(index: number) {
  emit(
    "update:searchFields",
    props.searchFields.filter((_, i) => i !== index),
  );
}
...
function updateField<K extends keyof SearchFieldSchema>(
  index: number,
  field: K,
  value: SearchFieldSchema[K],
) {
    ...
    >
      <div :class="styles['search-fields-editor__item-header']">
        <span :class="styles['search-fields-editor__item-title']">{{
          t("editor.searchFieldsEditor.fieldTitle", { index: idx + 1 })
        }}</span>
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.searchFieldsEditor.type")
        }}</label>
        <el-select
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.searchFieldsEditor.field")
        }}</label>
        <el-input
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.searchFieldsEditor.label")
        }}</label>
        <el-input
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.searchFieldsEditor.span")
        }}</label>
        <el-input-number
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.searchFieldsEditor.placeholder")
        }}</label>
        <el-input
          ...
          @update:model-value="
            updateField(idx, 'placeholder', $event || undefined)
          "
        />
      </div>
      ...
      <template v-if="needsOptions(field.type)">
        <div :class="styles['search-fields-editor__field']">
          <label :class="styles['search-fields-editor__label']">{{
            t("editor.searchFieldsEditor.options")
          }}</label>
          <el-input
            type="textarea"
        ...
        <div :class="styles['search-fields-editor__api-section']">
          <div :class="styles['search-fields-editor__field']">
            <label :class="styles['search-fields-editor__label']">{{
              t("editor.searchFieldsEditor.apiUrl")
            }}</label>
            <el-input
          ...
          <template v-if="field.api?.url">
            <div :class="styles['search-fields-editor__field']">
              <label :class="styles['search-fields-editor__label']">{{
                t("editor.searchFieldsEditor.apiMethod")
              }}</label>
              <el-select
                ...
                style="width: 100%"
                @update:model-value="
                  updateApiField(idx, { method: $event as 'get' | 'post' })
                "
              >
            ...
            <div :class="styles['search-fields-editor__field']">
              <label :class="styles['search-fields-editor__label']">{{
                t("editor.searchFieldsEditor.apiParams")
              }}</label>
              <el-input
                type="textarea"
            ...
            <div :class="styles['search-fields-editor__field']">
              <label :class="styles['search-fields-editor__label']">{{
                t("editor.searchFieldsEditor.dataPath")
              }}</label>
              <el-input
                ...
                placeholder="data"
                @update:model-value="
                  updateApiField(idx, { dataPath: $event || undefined })
                "
              />
            </div>
            ...
            <div
              :class="[
                styles['search-fields-editor__field'],
                styles['api-config__field--row'],
              ]"
            >
              <div style="flex: 1">
                <label :class="styles['search-fields-editor__label']">{{
                  t("editor.searchFieldsEditor.labelKey")
                }}</label>
                <el-input
                  ...
                  placeholder="label"
                  @update:model-value="
                    updateApiField(idx, { labelKey: $event || undefined })
                  "
                />
              </div>
              <div style="flex: 1">
                <label :class="styles['search-fields-editor__label']">{{
                  t("editor.searchFieldsEditor.valueKey")
                }}</label>
                <el-input
                  ...
                  placeholder="value"
                  @update:model-value="
                    updateApiField(idx, { valueKey: $event || undefined })
                  "
                />
              </div>
            </div>
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.searchFieldsEditor.defaultValue")
        }}</label>
        <el-input
