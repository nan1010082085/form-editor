...
const actionTypeOptions = computed<ActionTypeOption[]>(() => [
  ...
  {
    label: t("editor.actionButtonsEditor.actionOpenDialog"),
    value: "open-dialog",
  },
  {
    label: t("editor.actionButtonsEditor.actionCloseDialog"),
    value: "close-dialog",
  },
  {
    label: t("editor.actionButtonsEditor.actionSwitchTab"),
    value: "switch-tab",
  },
  ...
  {
    label: t("editor.actionButtonsEditor.actionTriggerEvent"),
    value: "trigger-event",
  },
  {
    label: t("editor.actionButtonsEditor.actionSetVariable"),
    value: "set-variable",
  },
  ...
  {
    label: t("editor.actionButtonsEditor.actionPostMessage"),
    value: "post-message",
  },
  ...
  {
    label: t("editor.actionButtonsEditor.actionStartFlow"),
    value: "startFlow",
  },
...
function updateButton<K extends keyof ActionButton>(
  index: number,
  field: K,
  value: ActionButton[K],
) {
...
<template>
  <div :class="styles['action-buttons-editor']">
    <div
      ...
      :class="styles['action-buttons-editor__empty']"
    >
    ...
    >
      ...
      <div :class="styles['action-buttons-editor__item-header']">
        <span :class="styles['action-buttons-editor__item-title']">{{
          btn.label || btn.key
        }}</span>
      ...
      <div :class="styles['action-buttons-editor__row']">
        <div :class="styles['action-buttons-editor__field']">
          ...
          <el-input
            :model-value="btn.key"
            size="small"
            @update:model-value="(v: string) => updateButton(idx, 'key', v)"
          />
        </div>
        <div :class="styles['action-buttons-editor__field']">
          <label :class="styles['action-buttons-editor__label']">{{
            t("editor.actionButtonsEditor.text")
          }}</label>
          <el-input
            :model-value="btn.label"
            size="small"
            @update:model-value="(v: string) => updateButton(idx, 'label', v)"
          />
        </div>
      </div>
      ...
      <div :class="styles['action-buttons-editor__row']">
        <div :class="styles['action-buttons-editor__field']">
          ...
          <el-select
            ...
            @update:model-value="
              (v: string) =>
                updateButton(idx, 'type', v as ActionButton['type'])
            "
          >
            <el-option
        ...
        <div :class="styles['action-buttons-editor__field']">
          <label :class="styles['action-buttons-editor__label']">{{
            t("editor.actionButtonsEditor.icon")
          }}</label>
          <el-input
            :model-value="btn.icon ?? ''"
            size="small"
            :placeholder="t('editor.actionButtonsEditor.iconPlaceholder')"
            @update:model-value="
              (v: string) => updateButton(idx, 'icon', v || undefined)
            "
          />
        </div>
      </div>
      ...
      <div :class="styles['action-buttons-editor__field']">
        <label :class="styles['action-buttons-editor__label']">{{
          t("editor.actionButtonsEditor.visibleCondition")
        }}</label>
        <el-input
          :model-value="btn.visibleCondition ?? ''"
          size="small"
          :placeholder="
            t('editor.actionButtonsEditor.visibleConditionPlaceholder')
          "
          @update:model-value="
            (v: string) => updateButton(idx, 'visibleCondition', v || undefined)
          "
        />
      </div>
      ...
      <div :class="styles['action-buttons-editor__field']">
        <label :class="styles['action-buttons-editor__label']">{{
          t("editor.actionButtonsEditor.confirmPrompt")
        }}</label>
        <el-input
          ...
          @update:model-value="
            (v: string) => updateButton(idx, 'confirm', v || undefined)
          "
        />
      </div>
      ...
      <!-- Events toggle -->
      <div
        :class="styles['action-buttons-editor__events-toggle']"
        @click="toggleEvents(idx)"
      >
        <AppIcon
          :name="expandedEvents === idx ? 'arrow-down' : 'arrow-right'"
        />
        <span>{{
          t("editor.actionButtonsEditor.eventsConfig", {
            count: btn.events?.length || 0,
          })
        }}</span>
      </div>
      ...
      <!-- Events editor -->
      <div
        v-if="expandedEvents === idx"
        :class="styles['action-buttons-editor__events']"
      >
        <div
          v-if="!btn.events?.length"
          :class="styles['action-buttons-editor__events-hint']"
        >
    ...
    >
      <AppIcon name="plus" />
      {{ t("editor.actionButtonsEditor.addButtonText") }}
    </el-button>
  </div>
</template>
