...
async function handleApplyTemplate(template: TemplateItem) {
  try {
    ...
    ElMessage.success(
      t("editor.leftPanel.templateApplied", { name: template.name }),
    );
  } catch {
...
<template>
  <aside :class="styles['left-panel']">
    ...
    <div :class="styles['left-panel__tabs']">
      <button
        :class="[
          styles['left-panel__tab'],
          { [styles['left-panel__tab--active']]: activeTab === 'components' },
        ]"
      ...
      <button
        :class="[
          styles['left-panel__tab'],
          { [styles['left-panel__tab--active']]: activeTab === 'structure' },
        ]"
      ...
      <button
        :class="[
          styles['left-panel__tab'],
          { [styles['left-panel__tab--active']]: activeTab === 'templates' },
        ]"
      ...
      >
        {{
          schemaStatus === "published"
            ...
            : t("editor.leftPanel.statusDraft")
        }}
      </span>
      <span
        :class="[
