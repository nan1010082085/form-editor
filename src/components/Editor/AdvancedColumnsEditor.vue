...
import type {
  AdvancedTableColumn,
  ActionButton,
} from "@/widgets/advanced-table/config";
...
const fixedOptions = [
  {
    ...
    value: undefined as "left" | "right" | undefined,
  },
...
const actionTypeOptions: ActionTypeOption[] = [
  ...
  {
    label: t("editor.columnsEditor.actionTriggerEvent"),
    value: "trigger-event",
  },
...
function updateColumn<K extends keyof AdvancedTableColumn>(
  index: number,
  field: K,
  value: AdvancedTableColumn[K],
) {
...
function optionsToText(
  opts?: Array<{ label: string; value: unknown }>,
): string {
...
function removeFilter(colIndex: number, filterIndex: number) {
  const filters = (props.columns[colIndex].filters || []).filter(
    (_, i) => i !== filterIndex,
  );
...
function removeRowButton(colIndex: number, btnIndex: number) {
  const buttons = (props.columns[colIndex].buttons || []).filter(
    (_, i) => i !== btnIndex,
  );
  updateColumn(colIndex, "buttons", buttons);
}
...
function updateRowButtonEvents(
  colIndex: number,
  btnIndex: number,
  ...
  <div :class="styles['adv-columns-editor']">
    <div :class="styles['adv-columns-editor__preset-bar']">
      ...
      <el-select
        ...
        :placeholder="t('editor.columnsEditor.selectPreset')"
        clearable
        size="small"
        style="width: 180px"
      >
    ...
    <div
      ...
      :class="styles['adv-columns-editor__empty']"
    >
    ...
    >
      ...
      <div :class="styles['adv-columns-editor__item-header']">
        <span :class="styles['adv-columns-editor__item-title']"
      ...
      <div :class="styles['adv-columns-editor__row']">
        ...
        <div
          v-if="col.width !== 'auto'"
          :class="styles['adv-columns-editor__field']"
        >
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.width")
          }}</label>
          <el-input
            ...
            @update:model-value="
              (v: string) =>
                updateColumn(idx, 'width', v ? Number(v) : undefined)
            "
          />
        </div>
      </div>
      ...
      <div :class="styles['adv-columns-editor__row']">
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.minWidth")
          }}</label>
          <el-input
            ...
            @update:model-value="
              (v: string) =>
                updateColumn(idx, 'minWidth', v ? Number(v) : undefined)
            "
          />
        </div>
      </div>
      ...
      <div :class="styles['adv-columns-editor__row']">
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.renderMode")
          }}</label>
          <el-select
            ...
            @update:model-value="
              (v: string) =>
                updateColumn(idx, 'render', v as AdvancedTableColumn['render'])
            "
          >
            <el-option
        ...
        <div :class="styles['adv-columns-editor__field']">
          ...
          <el-select
            ...
            @update:model-value="
              (v: string) =>
                updateColumn(idx, 'align', v as AdvancedTableColumn['align'])
            "
          >
            <el-option
      ...
      <div :class="styles['adv-columns-editor__row']">
        <div :class="styles['adv-columns-editor__field']">
          ...
          <el-select
            ...
            @update:model-value="
              (v: string) =>
                updateColumn(idx, 'fixed', v as AdvancedTableColumn['fixed'])
            "
          >
            <el-option
        ...
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.sorting")
          }}</label>
          <el-switch
            :model-value="col.sortable ?? false"
            @update:model-value="
              (v: boolean) => updateColumn(idx, 'sortable', v)
            "
          />
        </div>
      </div>
      ...
      <div :class="styles['adv-columns-editor__row']">
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.overflowTooltip")
          }}</label>
          <el-switch
            :model-value="col.showTooltip ?? false"
            @update:model-value="
              (v: boolean) => updateColumn(idx, 'showTooltip', v)
            "
          />
        </div>
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.tooltipField")
          }}</label>
          <el-input
            :model-value="col.tooltipField ?? ''"
            size="small"
            placeholder="tooltipField"
            @update:model-value="
              (v: string) => updateColumn(idx, 'tooltipField', v || undefined)
            "
          />
        </div>
      </div>
      ...
      <div :class="styles['adv-columns-editor__field']">
        <label :class="styles['adv-columns-editor__label']">{{
          t("editor.columnsEditor.columnFilter")
        }}</label>
        <el-switch
          :model-value="col.filterable ?? false"
          @update:model-value="
            (v: boolean) => updateColumn(idx, 'filterable', v)
          "
        />
      </div>
      ...
      <div
        v-if="col.filterable"
        :class="styles['adv-columns-editor__filters-section']"
      >
        <label :class="styles['adv-columns-editor__label']">{{
          t("editor.columnsEditor.filterItems")
        }}</label>
        ...
        <div
          ...
          :class="styles['adv-columns-editor__empty-hint']"
        >
          {{ t("editor.columnsEditor.noCustomFilters") }}
        </div>
        <div
        ...
        >
          <div :class="styles['adv-columns-editor__row']">
            <div :class="styles['adv-columns-editor__field']">
              <label :class="styles['adv-columns-editor__label']">{{
                t("editor.columnsEditor.filterDisplayText")
              }}</label>
              <el-input
            ...
            <div :class="styles['adv-columns-editor__field']">
              <label :class="styles['adv-columns-editor__label']">{{
                t("editor.columnsEditor.filterMatchValue")
              }}</label>
              <el-input
      ...
      <!-- link render fields -->
      <div
        v-if="col.render === 'link'"
        :class="styles['adv-columns-editor__field']"
      >
        <label :class="styles['adv-columns-editor__label']">{{
          t("editor.columnsEditor.linkEventName")
        }}</label>
        <el-input
      ...
      <template v-if="col.render === 'tag' || col.render === 'badge'">
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.dictCode")
          }}</label>
          <el-input
            :model-value="col.dictCode ?? ''"
            size="small"
            placeholder="leave_type"
            @update:model-value="
              (v: string) => updateColumn(idx, 'dictCode', v || undefined)
            "
          />
        </div>
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.colorMap")
          }}</label>
          <el-input
        ...
        <div :class="styles['adv-columns-editor__field']">
          <label :class="styles['adv-columns-editor__label']">{{
            t("editor.columnsEditor.staticOptions")
          }}</label>
          <el-input
        ...
        <div :class="styles['adv-columns-editor__api-section']">
          <div :class="styles['adv-columns-editor__field']">
            <label :class="styles['adv-columns-editor__label']">{{
              t("editor.columnsEditor.dynamicOptionsApi")
            }}</label>
            <el-input
              ...
              @update:model-value="
                (v: string) => updateColumnApi(idx, { url: v || '' })
              "
            />
          </div>
          <template v-if="col.api?.url">
            <div :class="styles['adv-columns-editor__row']">
              <div :class="styles['adv-columns-editor__field']" style="flex: 1">
                ...
                <el-select
                  ...
                  @update:model-value="
                    (v: string) =>
                      updateColumnApi(idx, { method: v as 'get' | 'post' })
                  "
                >
              ...
              <div :class="styles['adv-columns-editor__field']" style="flex: 1">
                <label :class="styles['adv-columns-editor__label']">{{
                  t("editor.columnsEditor.dataPath")
                }}</label>
                <el-input
                  ...
                  @update:model-value="
                    (v: string) =>
                      updateColumnApi(idx, { dataPath: v || undefined })
                  "
                />
              </div>
            </div>
            <div :class="styles['adv-columns-editor__field']">
              <label :class="styles['adv-columns-editor__label']">{{
                t("editor.columnsEditor.paramsJson")
              }}</label>
              <el-input
                ...
                @update:model-value="
                  (v: string) => handleApiParamsChange(idx, v)
                "
              />
            </div>
            <el-button
              ...
              plain
              style="width: 100%"
              @click="removeColumnApi(idx)"
              >{{ t("editor.columnsEditor.removeApi") }}</el-button
            >
          </template>
        </div>
      </template>
      ...
      <!-- image render fields -->
      <div
        v-if="col.render === 'image'"
        :class="styles['adv-columns-editor__field']"
      >
        <label :class="styles['adv-columns-editor__label']">{{
          t("editor.columnsEditor.imageWidth")
        }}</label>
        <el-input-number
          :model-value="col.imageWidth ?? 40"
          :min="20"
          :max="400"
          size="small"
          style="width: 100%"
          @update:model-value="
            (v: number) => updateColumn(idx, 'imageWidth', v)
          "
        />
      </div>
      ...
      <div
        v-if="col.render === 'custom'"
        :class="styles['adv-columns-editor__field']"
      >
        <label :class="styles['adv-columns-editor__label']">{{
          t("editor.columnsEditor.renderFn")
        }}</label>
        <el-input
          :model-value="col.renderFn ?? ''"
          size="small"
          placeholder="renderFn"
          @update:model-value="
            (v: string) => updateColumn(idx, 'renderFn', v || undefined)
          "
        />
      </div>
      ...
      <div
        v-if="col.render === 'buttons'"
        :class="styles['adv-columns-editor__buttons-section']"
      >
        <label :class="styles['adv-columns-editor__label']">{{
          t("editor.columnsEditor.inlineButtons")
        }}</label>
        <div
          v-if="!col.buttons?.length"
          :class="styles['adv-columns-editor__empty-hint']"
        >
          {{ t("editor.columnsEditor.noButtons") }}
        </div>
        <div
        ...
        >
          <div :class="styles['adv-columns-editor__btn-header']">
            <span :class="styles['adv-columns-editor__btn-title']">{{
              btn.label || btn.key
            }}</span>
            <el-button
              type="danger"
          ...
          <div :class="styles['adv-columns-editor__row']">
            <div :class="styles['adv-columns-editor__field']">
              ...
              <el-input
                ...
                size="small"
                @update:model-value="
                  (v: string) => updateRowButton(idx, bi, 'key', v)
                "
              />
            </div>
            <div :class="styles['adv-columns-editor__field']">
              <label :class="styles['adv-columns-editor__label']">{{
                t("editor.columnsEditor.buttonText")
              }}</label>
              <el-input
                :model-value="btn.label"
                size="small"
                @update:model-value="
                  (v: string) => updateRowButton(idx, bi, 'label', v)
                "
              />
            </div>
          </div>
          <div :class="styles['adv-columns-editor__row']">
            <div :class="styles['adv-columns-editor__field']">
              ...
              <el-select
                ...
                style="width: 100%"
                @update:model-value="
                  (v: string) => updateRowButton(idx, bi, 'type', v)
                "
              >
                <el-option
            ...
            <div :class="styles['adv-columns-editor__field']">
              <label :class="styles['adv-columns-editor__label']">{{
                t("editor.columnsEditor.confirmPrompt")
              }}</label>
              <el-input
          ...
          <div :class="styles['adv-columns-editor__field']">
            <label :class="styles['adv-columns-editor__label']">{{
              t("editor.columnsEditor.visibleCondition")
            }}</label>
            <el-input
          ...
          <!-- Button events -->
          <div
            :class="styles['adv-columns-editor__btn-events-toggle']"
            @click="toggleButtonEvents(`${idx}-${bi}`)"
          >
            <AppIcon
              :name="
                expandedButtonEvents === `${idx}-${bi}`
                  ? 'arrow-down'
                  : 'arrow-right'
              "
            />
            <span
              >{{ t("editor.columnsEditor.eventConfig") }} ({{
                btn.events?.length || 0
              }})</span
            >
          </div>
          <div
            v-if="expandedButtonEvents === `${idx}-${bi}`"
            :class="styles['adv-columns-editor__btn-events']"
          >
            <ActionListEditor
