...
const typeOptions = computed(() => [
  {
    label: t("editor.crudFormFieldsEditor.typeInput"),
    value: "input" as const,
  },
  {
    label: t("editor.crudFormFieldsEditor.typeTextarea"),
    value: "textarea" as const,
  },
  {
    label: t("editor.crudFormFieldsEditor.typeNumber"),
    value: "number" as const,
  },
  {
    label: t("editor.crudFormFieldsEditor.typeSelect"),
    value: "select" as const,
  },
  {
    label: t("editor.crudFormFieldsEditor.typeRadio"),
    value: "radio" as const,
  },
  {
    label: t("editor.crudFormFieldsEditor.typeSwitch"),
    ...
    >
      <div :class="styles['search-fields-editor__item-header']">
        <span :class="styles['search-fields-editor__item-title']">{{
          t("editor.crudFormFieldsEditor.fieldTitle", { index: idx + 1 })
        }}</span>
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.crudFormFieldsEditor.type")
        }}</label>
        <el-select
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.crudFormFieldsEditor.field")
        }}</label>
        <el-input
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.crudFormFieldsEditor.label")
        }}</label>
        <el-input
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.crudFormFieldsEditor.span")
        }}</label>
        <el-input-number
      ...
      <div :class="styles['search-fields-editor__field']">
        <label :class="styles['search-fields-editor__label']">{{
          t("editor.crudFormFieldsEditor.placeholder")
        }}</label>
        <el-input
      ...
      <template v-if="needsOptions(field.type)">
        <div :class="styles['search-fields-editor__field']">
          <label :class="styles['search-fields-editor__label']">{{
            t("editor.crudFormFieldsEditor.options")
          }}</label>
          <el-input
            type="textarea"
      ...
      <div :class="styles['search-fields-editor__field']">
        ...
        <el-input
          ...
          size="small"
          :placeholder="
            t('editor.crudFormFieldsEditor.defaultValuePlaceholder')
          "
