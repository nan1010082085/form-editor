...
describe("FgUpload", () => {
  ...
  describe("Store CRUD", () => {
    ...
    it("可更新属性", () => {
      ...
      store.updateWidget("test_widget", {
        props: { accept: ".jpg,.png", multiple: true, limit: 10 },
      });
  ...
  describe("属性", () => {
    it("accept 生效", () => {
      ...
      store.addWidget(widget);
      expect(store.findWidget("test_widget")!.props!.accept).toBe(
        ".jpg,.png,.gif",
      );
    });
    ...
    it("buttonText 生效", () => {
      ...
      store.addWidget(widget);
      expect(store.findWidget("test_widget")!.props!.buttonText).toBe(
        "上传文件",
      );
    });
  });
