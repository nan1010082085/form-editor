...
export function useAdvancedTableEvents(
  opts: UseAdvancedTableEventsOptions,
): AdvancedTableEventHandlers {
  const {
    widgetData,
    eventCtx,
    clickIntercept,
  ...
  function onPageChange(page: number) {
    ...
    if (eventCtx)
      triggerWidgetEvent(widgetData.value, "click", eventCtx, "page-change");
  }
