...
const filters = computed(
  () =>
    (widgetData.value.props?.filters as Array<Record<string, unknown>>) ?? [],
);
...
const searchPlaceholder = computed(
  () =>
    ...
    t("editor.filterBar.searchPlaceholder"),
);
  ...
  <div :class="styles.filterBar" :style="widgetStyle">
    <div :class="styles.filterItems">
      ...
      >
        ...
        >
          <el-option
            v-for="opt in (filter.options as Array<{
              label: string;
              value: unknown;
            }>) ?? []"
          ...
          <template #prefix>
            <el-icon
              ><svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
                  d="M1014.64 969.04L703.71 656.207c57.953-69.408 92.88-161.04 92.88-260.96C796.59 178.368 618.222 0 398.296 0 178.368 0 0 178.368 0 398.296s178.368 398.296 398.296 398.296c99.92 0 191.552-34.927 260.96-92.88l310.832 312.784c14.64 14.64 38.4 14.64 53.04 0l21.512-21.512c14.64-14.64 14.64-38.4 0-53.04zM398.296 721.6c-178.368 0-323.304-144.936-323.304-323.304S219.928 75 398.296 75s323.304 144.936 323.304 323.304-144.936 323.296-323.304 323.296z"
                /></svg
            ></el-icon>
          </template>
        </el-input>
