...
<template>
  <el-date-picker
    ...
    :style="dynamicStyle"
    :start-placeholder="
      (widgetData.props?.startPlaceholder as string) ||
      t('editor.dateTimeSlot.startPlaceholder')
    "
    :end-placeholder="
      (widgetData.props?.endPlaceholder as string) ||
      t('editor.dateTimeSlot.endPlaceholder')
    "
    :format="(widgetData.props?.format as string) || 'YYYY-MM-DD HH:mm:ss'"
    :range-separator="
      (widgetData.props?.rangeSeparator as string) ||
      t('editor.dateTimeSlot.rangeSeparator')
    "
